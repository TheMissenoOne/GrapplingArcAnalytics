...
DATASETS: list[tuple[str, str | None, str]] = [
    ...
    ("scripts.polaris4_data", "Polaris 4", "Polaris4"),
    ("scripts.polarispro1_data", "Polaris Pro 1", "PolarisPro1"),
    ("scripts.ethan_crelinsten_data", None, "EthanCrelinsten"),
    ("scripts.cji2day1_data", "CJI 2, Day 1", "CJI2Day1"),
    ("scripts.cji2day2_data", "CJI 2, Day 2", "CJI2Day2"),
    ("scripts.craigjones_data", None, "CraigJones"),
    ("scripts.pgf_world_2026_week_1_opening_day_data", "PGF World 2026", "PGF2026-W1"),
    ("scripts.pgf_world_2026_week_2_things_are_heating_up_data", "PGF World 2026", "PGF2026-W2"),
    ("scripts.pgf_world_2026_week_3_this_marks_the_halfway_point_data", "PGF World 2026", "PGF2026-W3"),
    ("scripts.pgf_world_2026_week_4_the_playoff_race_is_on_data", "PGF World 2026", "PGF2026-W4"),
    ("scripts.pgf_world_2026_week_5_regular_season_finale_data", "PGF World 2026", "PGF2026-W5"),
    ("scripts.polaris_25_prelims_live_full_no_gi_bjj_grappling_undercard_data", "Polaris 25", "Polaris25"),
    ("scripts.polaris_26_live_prelims_nine_free_matches_live_data", "Polaris 26", "Polaris26"),
    ("scripts.polaris_18_submission_grappling_full_bjj_event_replay_data", "Polaris 18", "Polaris18"),
    ("scripts.polaris_bjj_squads_team_usa_vs_team_uk_ireland_grappling_full_event_data", "Polaris BJJ Squads", "PolarisBJJSquads"),
    ("scripts.polaris28prelims_data", "Polaris 28", "Polaris28"),
    ("scripts.polaris29_data", "Polaris 29", "Polaris29"),
    ("scripts.polaris30_data", "Polaris 30", "Polaris30"),
    ("scripts.polaris31_data", "Polaris 31", "Polaris31"),
    ("scripts.polaris32_data", "Polaris 32", "Polaris32"),
    ("scripts.polaris33_data", "Polaris 33", "Polaris33"),
    ("scripts.polaris34_data", "Polaris 34", "Polaris34"),
    ("scripts.polaris35_data", "Polaris 35", "Polaris35"),
    ("scripts.polaris36_data", "Polaris 36", "Polaris36"),
    ...
    ("scripts.team_bjj_stars_vs_team_polaris_full_squads_matchup_polaris_37_data",
     "Team BJJ Stars vs Polaris", "BJJStarsVsPolaris"),
    ("scripts.eddie_bravo_invitational_14_the_absolutes_data", "EBI 14", "EBI14"),
    ("scripts.wno_30_open_weight_grand_prix_undercard_free_live_prelim_matches_data",
     "WNO 30", "WNO30"),
    ("scripts.ufc_320_free_fight_marathon_data", "UFC 320", "UFC320"),
    ("scripts.ufc_324_free_fight_marathon_data", "UFC 324", "UFC324"),
    ("scripts.ufc_327_free_fight_marathon_data", "UFC 327", "UFC327"),
    ("scripts.ufc_328_free_fight_marathon_data", "UFC 328", "UFC328"),
    ("scripts.evento_completo_final_do_jud_equipes_mistas_olimp_adas_paris_2024_data",
     "Paris 2024 Judo Mixed Team", "Judo2024MixedTeam"),
    ("scripts.supercut_the_entire_2024_adcc_worlds_65kg_bracket_data", "ADCC 2024", "ADCC2024-65kg"),
    ("scripts.leandro_lo_data", None, "LeandroLo"),
    ("scripts.ruotolos_data", None, "Ruotolos"),
]
