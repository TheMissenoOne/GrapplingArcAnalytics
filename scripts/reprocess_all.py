...
DATASETS: list[tuple[str, str | None, str]] = [
    ...
    # Frame-read (concordance-audited) batches -- scripts/adcc_trials2324_frames_to_dump.py,
    # see docs/gemini_concordance_audit.md. One module per event tag per this file's convention.
    ("scripts.dumps.adcc_trials2023_european_frames_data", "ADCC Trials 2023 European",
     "ADCCTrials2023EU-Frames"),
    ("scripts.dumps.adcc_trials2023_asia_oceania_frames_data", "ADCC Trials 2023 Asia & Oceania",
     "ADCCTrials2023AO-Frames"),
    ("scripts.dumps.adcc_trials2024_sa1_frames_data", "ADCC Trials 2024 South American 1",
     "ADCCTrials2024SA1-Frames"),
    ("scripts.dumps.adcc_trials2024_sa2_frames_data", "ADCC Trials 2024 South American 2",
     "ADCCTrials2024SA2-Frames"),
    ("scripts.dumps.adcc_trials2024_european_frames_data", "ADCC Trials 2024 European",
     "ADCCTrials2024EU-Frames"),
    ("scripts.dumps.adcc_trials2024_asia_oceania_frames_data", "ADCC Trials 2024 Asia & Oceania",
     "ADCCTrials2024AO-Frames"),
