...
| `poc/` | Executed PoC results: `e0.md` (generated tables) + `e0_notes.md` (reading); `e8.md` (interaction graph — criterion, tables, reading and verdict, all generated by `analysis/poc/e8_interaction_graph.py`; do not hand-edit). |
