...
# Public by evidence: something in the athlete corpus references it, or nothing does.
_RECANONICALISE = """
...
# Private by evidence: only a user graph names it. The label survives in graph_nodes.
_DELETE_PRIVATE = """
